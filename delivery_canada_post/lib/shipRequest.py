...
class SettlementInfo(canRequest):
    def __init__(self, values):
        ...
        self._tags = {"paid-by-customer": values.get('paid-by-customer'), "contract-id": values.get('contract-id') , 
            "cif-shipment": values.get('cif-shipment'), 
            "intended-method-of-payment": values.get('intended-method-of-payment'),"promo-code": values.get('promo_code')}
...
class Shipment(canRequest):
    def __init__(self, values):
        ...
        self._tags = values
        # self._tags = {"customer-request-id": values.get('customer-request-id') ,"group-id": values.get('group_id') ,"transmit-shipment":values.get('transmit-shipment'),
        #     "quickship-label-requested": values.get('quickship-label-requested') ,"cpc-pickup-indicator":values.get('cpc-pickup-indicator'),
        #     "requested-shipping-point": values.get('requested-shipping-point') ,"shipping-point-id":values.get('shipping-point-id'),
        #     "expected-mailing-date": values.get('expected-mailing-date') ,"provide-pricing-info":values.get('provide-pricing-info'),
        #     "provide-receipt-info": values.get('provide-receipt-info') ,"delivery-spec":values.get('delivery-spec')
        #     ,"return-spec":values.get('return_spec'),"pre-athorized-payment":values.get('pre-athorized-payment')}
        # self._order = ["customer-request-id", "requested-shipping-point","group-id","transmit-shipment","quickship-label-requested","cpc-pickup-indicator",
        #     "shipping-point-id", "expected-mailing-date","provide-pricing-info","provide-receipt-info" ,"delivery-spec","return-spec"
        #     ,"pre-athorized-payment"]
        self._order = []
        self._order += [key for key,value in _tags.items()]


class ReturnRecipient(canRequest):
    def __init__(self, values):
        self._Request = "return-recipient"
        self._tags = {"name": values.get('name') ,"company":values.get('company'),
...
class PreAuthroizedPayment(canRequest):
    def __init__(self, values):
        ...
        self._tags = {"account-number": values.get('account-number') ,"auth-code":values.get('auth-code'),
            "auth-timestamp": values.get('auth-timestamp'), "charge-amount": values.get('charge-amount')}
